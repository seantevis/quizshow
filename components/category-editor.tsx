          ...
          <div key={categoryIndex} className="bg-[#005AF2] p-4 rounded-lg">
            <div className="flex items-center gap-3">
              <Input
                ...
                className="flex-grow text-lg font-bold bg-[#0046c9] border-[#0046c9] text-white"
                placeholder="Category Name"
              />

              <Link href={`/editor/category/${categoryIndex}`}>
                <Button className="bg-[#f8d64e] hover:bg-[#e9c73f] text-[#00236A] font-bold">
                  Questions <ChevronRight size={18} className="ml-1" />
                </Button>
              </Link>
